 ...
 class GoalItem extends Component {
 	...
 	render() {
 		...
 		return (
 				<div style={{margin: '5px', borderBottom: "1px dashed black"}} className = "row">

	 				<strong className="col-xs-3" >{title}</strong>
	 				<span style={{margin: '5px'}} className = "col-xs-3">Submitted by: <em>{email}</em></span>
	 				<span style={{margin: '5px'}} className = "col-xs-3">Assigned to: <em>{team}</em></span>
	 				<button
